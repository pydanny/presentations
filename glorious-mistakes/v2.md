...
## Any gotcha can stop development
...
- Expedited via paid instruction
...
- Clever code addresses 80% of Django!
- Easy to get started!

- But..

    - Often breaks most of the third-party package ecosystem
    - Edge case insanity, 20% of Django remains
...
def main(country: str, year: int):
    print(f"PyCon {country} {year}")
