...
# [fit] Some of these are mine

---

# [fit] Some I witnessed
...
- XML was in fashion, APIs were powered by SOAP
...
## It took me 17 years to admit I did this
...
Tony Hoare said null pointer exceptions are a billion dollar mistake.

(Not really a problem in Python)

---

# Mistake: Removing None 

Questionable solution to a non-problem: Replacing None

```python
class NullPointerHandler:
    # 50 lines of embarrassing code that should not exist
```
...
1. Every Python stdlib that could return None
2. Every PyPI package that could return None
...
1. Devs code impossible complexity
2. Devs leave because stuck and much money spent
...
By adding types to Python are

---

By adding types to Python are

we repeating the mistakes of Zope?
...
# Join me in electrifying the world
...
Helping obscenely rich people not paying taxes do:

# [fit] Interfering with elections

# [fit] Taking away civil rights

# [fit] Improve petroleum industry
